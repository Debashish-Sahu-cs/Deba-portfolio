  ...
  <section className="about-inner">
    ...
    <div className="about-grid">
        ...
        <div className="about-text-wrap left" id="skill-text">
          <p className="about-text">
            - <span className="highlighted">Frontend:</span>HTML, CSS, JavaScript, React.js
            <br />
            - <span className="highlighted">Backend:</span> Node.js with Express.js framework(primary), familiar with Java, Python and PHP
            <br />
            - <span className="highlighted">Databases:</span> SQL, MySQL
            <br />
